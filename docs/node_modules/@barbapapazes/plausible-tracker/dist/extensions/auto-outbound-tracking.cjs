...
exports.useAutoOutboundTracking = useAutoOutboundTracking;
var _utils = require("./utils.cjs");
function useAutoOutboundTracking(plausible, initOptions) {
  const options = {
    ...initOptions
  };
  ...
  function handleLinkClickEvent(event) {
    ...
    if (event.type === "auxclick" && event.button !== 1 || !(0, _utils.isOutboundLink)(this, location2)) return;
